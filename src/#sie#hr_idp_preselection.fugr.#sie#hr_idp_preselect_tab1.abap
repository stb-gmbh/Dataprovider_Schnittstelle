FUNCTION /sie/hr_idp_preselect_tab1.
*"----------------------------------------------------------------------
...
*  DATA tabname TYPE dd03l-tabname.
  ...
  IF callcontrol-step = 'SELECT'.
    IMPORT tabname1 FROM MEMORY ID '/SIE/HR_IDP_PRESEL1'.
*    IMPORT tabname1  FROM MEMORY ID '/SIE/HR_IDP_PRESEL'.
    IF tabname1 CP 'PA*'.
      SELECT * FROM dd03l
          INTO CORRESPONDING FIELDS OF TABLE h_itab
        WHERE tabname = tabname1 AND
              fieldname NOT IN
