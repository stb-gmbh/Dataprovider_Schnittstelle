function /sie/hr_idp_scd_pers_stat.
*"--------------------------------------------------------------------
...
form get_empl_type
  ...
  data:    wa_map_empl_type type /sie/hr_iscdpsta.
  statics: ta_map_empl_type type table of /sie/hr_iscdpsta.

*  Mappingtabelle für  lesen und puffern
  if ta_map_empl_type[] is initial.
    select * from /sie/hr_iscdpsta
