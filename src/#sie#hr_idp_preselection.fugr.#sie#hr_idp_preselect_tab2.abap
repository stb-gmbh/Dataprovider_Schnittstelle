FUNCTION /sie/hr_idp_preselect_tab2.
*"----------------------------------------------------------------------
...
*  DATA tabname TYPE dd03l-tabname.
  ...
  IF callcontrol-step = 'SELECT'.
    IMPORT tabname2 FROM MEMORY ID '/SIE/HR_IDP_PRESEL2'.
*    IMPORT tabname2  FROM MEMORY ID '/SIE/HR_IDP_PRESEL'.
    IF tabname2 CP 'PA*'.
      SELECT * FROM dd03l
          INTO CORRESPONDING FIELDS OF TABLE h_itab
        WHERE tabname = tabname2 AND
              fieldname NOT IN
