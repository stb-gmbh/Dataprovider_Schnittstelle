FUNCTION /sie/hr_idp_preselect_tab3.
*"----------------------------------------------------------------------
...
*  DATA tabname TYPE dd03l-tabname.
  ...
  DATA  tabname3 TYPE tabname.

  IF callcontrol-step = 'SELECT'.
    IMPORT tabname3 FROM MEMORY ID '/SIE/HR_IDP_PRESEL3'.
*    IMPORT tabname3  FROM MEMORY ID '/SIE/HR_IDP_PRESEL'.
    IF tabname3 CP 'PA*'.
      SELECT * FROM dd03l
          INTO CORRESPONDING FIELDS OF TABLE h_itab
        WHERE tabname = tabname3 AND
              fieldname NOT IN
